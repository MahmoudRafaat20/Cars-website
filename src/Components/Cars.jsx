    ...
    return (
        <div className='cars mx-1'>
            <div className="input-group text-center " >
                ...
                <input type="text" className="form-control cars-search  " placeholder="Search by name" aria-label="Recipient's username" aria-describedby="button-addon2" />
                <button className="btn btn-primary" type="button" id="button-addon2">Search</button>
            </div>
            <div className="row d-flex mx-4 my-4">
